# Source: This file is an updated and bug-free version of code from https://github.com/ustroetz/python-osrm
import sys
import base64
import numpy as np
...
class DefaultRequestConfig:
    def __init__(self):
        self.host = "router.project-osrm.org"
...
def simple_route(coord_origin, coord_dest, coord_intermediate=None,
    ...
    req = requests.get("".join(url), proxies=proxies)
#     print(req.text)
#     print(json.dumps(req.json(), indent=4))
#     print(req.json()['routes'][0]['geometry'])
#     # req = Request("".join(url))
#     if url_config.auth:
#         req.add_header("Authorization", url_config.auth)
#     rep = urlopen(req)
    parsed_json = req.json() #json.loads(rep.read().decode('utf-8'))
